...
"""
  Moustache commands:
      {{ command [args]}}
  Currently:
  {{ref NAME}}                   - insert reference, see "references" dictionary below
  {{refa NAME}}                  - insert an anchoring reference, see "references" dictionary below
  {{refsec section-id}}          - insert a reference to a (sub)section
  {{refto NAME}}                 - insert a reference to an existing anchoring reference, see "references" dictionary below
